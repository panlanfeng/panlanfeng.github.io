...
![摄像头正对着屏幕](/blog/_pic/triangle000.png)
![摄像头旋转一下](/blog/_pic/tri70-20-0.png)
![多旋转一点](/blog/_pic/tri70.png)
![颠倒过来是完全不一样的图](/blog/_pic/triangle180.png)
![试试五台摄像头](/blog/_pic/triangle180.png)
...
代码 
    ...
    grid.newpage()
    re(13, vp.list = list(vp1, vp2, vp3), function()grid.polygon(c(0, 1, .5), c(0, 0, 1), gp=gpar(col="green")))
    ...
    grid.newpage()
    re(13, vp.list = list(vp1, vp2, vp3, vp4,vp5), function()grid.polygon(c(0, 1, .5), c(0, 0, 1), gp=gpar(col="green")))
