...
This interpretation may sound intriguing, but it is ad-hoc. As R.A. Fitsher's famous saying, "all models are wrong, but some are useful." Perhaps the best way to justify your model is to look at the data, and it is the data where the story lies in.
